<template>
    <div class="main-container">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 my-3 gap-8">
            ...
            <div class="col-span-1 xl:col-span-2">
                ...
                <div class="mt-6">
                    <div class="mb-1">
                        ...
                        <span class="text-slate-500 dark:text-slate-400 text-lg font-normal leading-7 tracking-tight">
                            ({{ $t('Optional') }})
                        </span>
                    </div>
            ...
            <!-- Order Summary -->
            <BuyNowCheckoutOrderSummary :note="note" :isDigitalProduct="basketStore.buyNowProduct?.products[0]?.is_digital" />
...
.form-input {
    @apply p-3 rounded-lg border border-slate-200 dark:border-slate-700 focus:border-primary w-full outline-none text-base font-normal leading-normal placeholder:text-slate-400 bg-white dark:bg-slate-700 dark:text-white dark:placeholder:text-slate-500;
}
